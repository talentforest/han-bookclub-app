...
| 버전   | 배포 날짜 | 업데이트 사항                                                                                                                                                                                |
| ------ | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v0.0.0 | 22.06.30  | <ol><li>이달의 모임 정보</li><li>발제문 / 추천책 / 모임 후기 등록 기능</li><li>모임 히스토리 페이지</li><li>모임 관련 투표 페이지</li><li>나의 프로필, 선호하는 책분야 설정 페이지</li></ol> |
| v1.0.0 | 24.01.29  | <ol><li>전체 페이지 UI 변경</li><li>직접 모임책 등록 기능 추가</li><li>챌린지 페이지 추가</li><li>공유하고 싶은 문구 기능 추가</li><li>불참 멤버 설정 페이지</li></ol>                       |
| v2.0.0 | 24.06.14  | <ol><li>PWA 앱, 푸시 알림 설정</li><li>카카오톡 공유하기 기능 삭제</li><li>독서모임 한페이지 월별 정보(불참, 페널티 정보)</li><li>페널티 자동 부과</li><li>이전 투표 버그 수정</li><li>일반 투표에서 모임책 투표로 변경</li></ol>
...
첫 기획부터 출시, 그리고 계속되는 업데이트, 유지보수에서 정말 배운 것이 많았던 것 같습니다. IT 관련 배경을 전혀 갖고 있지 않은 분들과 함께 기획을 하면서 직접 프로토타입을 만들고 보여주며 그들의 의견을 더 이끌어내기 위해 적극적으로 소통하며 행동했고 무사히 기획을 잘 마칠 수 있었습니다. 아무래도 혼자 개발을 하다보니 어떤 기능을 만들어야 할지, 만든다면 기능 요구사항에는 어떤 것이 있는지, 어떤 로직으로 만드는 것이 효율적일지 고민하는 것이 어려웠는데, 그래도 멤버들이 같이 적극적으로 의견을 내주어서 많은 도움이 되었습니다.

첫 출시를 하고 난 이후에는 유지보수를 하면서 프로젝트에 대한 제대로 된 형상을 만들어 나가는 데 온 힘을 쏟았는데요. 그 과정에서 더 효율적인 Firebase 데이터베이스 구조와 프로젝트 파일 구조에 대해 많은 고민을 했던 것 같습니다. 또한 렌더링을 최적화하고, 커스텀 훅들을 만들면서 React를 활용하는 법에 대해서도 한단계 더 성장한 것을 느낄 수 있었습니다. 계속해서 테스트를 하며 유지보수를 했고, 독서모임 멤버들이 좋아할만한 기능이 무엇일지 고민하며 기획하고 업데이트했던 것 같습니다.

그 결과로 현재 2024년에는 버전 3.0.0이 나왔는데요. (독서모임은 계속되고 있습니다🔥) 확실히 모임장이 모임 전반을 관리하며 시간을 투자해야하는 것과 달리 독서모임 한페이지 앱 덕분에 앱에서 모든 정보를 확인할 수 있고, 기록할 수 있다 보니 멤버들의 만족도가 높았습니다. 실제로도 첫 출시 이후 어플리케이션에 필수 발제문 기록만 올렸다면 다양한 기능 업데이트를 통해 이제는 정리 기록 작성, 다음달 모임책 등록, 챌린지 등등에 참여했고 전년도 대비 읽기는 30%, 쓰기는 15% 정도 큰폭으로 상승했습니다. 그리고 이제는 PWA 애플리케이션으로 전환하여 멤버들이 더욱 편하게 접근할 수 있고 푸시 알림을 받을 수 있기 때문에 참여율을 높아질 것이라고 생각합니다. 

제가 실제로 서비스하는 첫 프로젝트인만큼 기획부터 출시까지 굉장한 열정을 갖고 만들었던 것 같습니다. 그리고 그 과정이 굉장히 즐거웠습니다. 앞으로도 독서모임에 특화된 모임 어플리케이션으로 업데이트하고 유지보수하려고합니다!
