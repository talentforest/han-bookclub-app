...
export default function RankStage<T>({
  ...
  return (
    <div className="relative mx-auto w-full max-w-[260px]">
      ...
      <div className="absolute bottom-[34%] flex h-32 w-full items-end justify-around">
        <div className="mb-1 flex h-fit items-end justify-center">
          {secondRank.length !== 0
        ...
        {/* 1위 */}
        <div className="mb-[42px] flex h-fit max-w-20 items-end justify-center">
          {firstRank.length !== 0
